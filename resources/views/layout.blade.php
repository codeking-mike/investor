            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <ul class="header-search me-lg-4">
                        <li class="get-btn">
                            <a href="/register" class="btn btn-style btn-primary" title="search">Register <i class="fas fa-arrow-right ms-lg-4 ms-2"></i></a>
                            <a href="/login" class="btn btn-style transparant-btn ms-sm-3" title="search">Login <i class="fas fa-arrow-right ms-lg-4 ms-2"></i></a>
        ...
        <div class="footer-29 py-5">
            <div class="container py-lg-4">
                    ...
                    <div class="col-lg-3 col-md-6 footer-list-29 footer-3 mt-lg-0 mt-5 pe-lg-5">
                        ...
                        <div class="footer-listw3-grids">
                            <ul class="footer-listw3">
                                ...
                                <li><a href="mailto:Workcore@mail.com" class="mail">info@bonretours.com</a></li>
                ...
                <div class="bottom-copies text-center">
                    <p class="copy-footer-29">© Bonretours @php date("Y")  @endphp. All rights reserved </p>
                </div>
            </div>
        </div>
